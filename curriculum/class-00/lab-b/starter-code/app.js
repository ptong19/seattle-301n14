...
//  Undefined the funtion dont get any its own value to invoked with.

// 2. What is "this" when joe.scopeArrow() is invoked?
//  base object, because it didn't have its own "this", looks like the enclosing scope, which can be the window, in this case.

// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions are not designed to be used with this.
