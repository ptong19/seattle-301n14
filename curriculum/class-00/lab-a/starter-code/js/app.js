...
function displayPics(){
  ...
  // Rando now throws an error due to let is block-scoped, and using it means that rando is declared only within while loop, instead to access within entire function displayPics().
